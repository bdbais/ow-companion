...
val Reports: List<Report> = listOf(
    Report(1, R.string.report_1, Report.Status.Fixed, "1.8.0"),
    Report(2, R.string.report_2, Report.Status.Fixed, "1.8.0"),
    Report(3, R.string.report_3, Report.Status.Fixed, "1.8.0"),
    Report(4, R.string.report_4, Report.Status.Fixed, "1.8.0"),
    Report(5, R.string.report_5, Report.Status.Fixed, "1.8.0"),
    Report(6, R.string.report_6, Report.Status.Fixed, "1.7.9"),
    Report(7, R.string.report_7, Report.Status.Fixed, "1.7.9"),
    ...
    Report(12, R.string.report_12, Report.Status.Fixed, "1.8.0"),
)
