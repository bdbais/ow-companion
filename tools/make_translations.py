...
TRANSLATIONS: dict[str, dict] = {
    ...
    "comics_official_body": t(
        es="Blizzard publica los cómics y los relatos en su propio sitio. Esto abre la galería allí, en tu idioma cuando la historia también existe en él.",
        pt="A Blizzard publica os quadrinhos e os contos no próprio site. Isto abre a galeria lá, no seu idioma quando a história também existe nele.",
        fr="Blizzard publie les BD et les nouvelles sur son propre site. Ceci ouvre la galerie là-bas, dans votre langue lorsque l\'histoire y existe aussi.",
        de="Blizzard veröffentlicht die Comics und Kurzgeschichten auf der eigenen Seite. Dies öffnet die Galerie dort, in deiner Sprache, sofern es die Geschichte darin gibt.",
        ja="コミックと短編はBlizzardの公式サイトで公開されています。ここからそのギャラリーを開きます。その言語版がある場合はあなたの言語で表示されます。",
        ko="만화와 단편은 블리자드 공식 사이트에 실려 있습니다. 여기서 그 갤러리를 엽니다. 해당 언어판이 있으면 여러분의 언어로 열립니다.",
        zhCN="漫画和短篇故事发布在暴雪自己的网站上。这里会打开那个图库，如果该语言版本存在，就用你的语言显示。",
        zhTW="漫畫和短篇故事發布在暴雪自己的網站上。這裡會開啟那個圖庫，如果該語言版本存在，就用你的語言顯示。",
        ru="Blizzard публикует комиксы и рассказы на своём сайте. Отсюда открывается их галерея — на вашем языке, если история на нём существует.",
        uk="Blizzard публікує комікси та оповідання на своєму сайті. Звідси відкривається їхня галерея — вашою мовою, якщо історія нею існує.",
        sv="Blizzard publicerar serierna och novellerna på sin egen sajt. Det här öppnar galleriet där, på ditt språk när berättelsen finns på det.",
        ar="تنشر Blizzard القصص المصورة والقصص القصيرة على موقعها. هذا يفتح المعرض هناك، بلغتك إن كانت القصة متوفرة بها.",
        pl="Blizzard publikuje komiksy i opowiadania na własnej stronie. To otwiera tamtejszą galerię, w twoim języku, jeśli historia w nim istnieje.",
        tr="Blizzard çizgi romanları ve öyküleri kendi sitesinde yayımlıyor. Bu, oradaki galeriyi açar; öykü o dilde varsa senin dilinde açılır.",
    ),
